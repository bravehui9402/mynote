...
- 手机：13306306855
- Email：whlh940228@163.com（```虽然我觉得QQ邮箱无所谓，不过有些技术人员比较反感，建议用G```）
- 微信号：hahahui940228个通过网络可以联系到你的方式```）
...
- 后端框架：Spring/SpringMVC/Mybatis/SringBoot/SpringCloud
- 中间件：Kafka/Redis/Solr/
- 数据库：MySQL/Oracle
- 版本管理：Svn/Git
